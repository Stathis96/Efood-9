...
namespace MrDelivery
{
    public partial class S4 : Form
    {
        ...
        double ichange;
        const double Price_Ham = 4.5;
        const double Price_CheeseBurger = 5.5;
        const double Price_BBQBurger = 6.5;
        const double Price_Jack = 8.5;
        const double Price_Black = 10.2;
        const double Price_Philly = 7.5;
        const double Price_Chicken = 6.3;
        const double Price_Veggie = 7.5;
        const double Price_Ceasars = 5.0;
        const double Price_Chef = 5.5;
        const double Price_Xwriatikh = 4.5;
        const double Price_Epoxhs = 3.0;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            itemcost[0] = Convert.ToDouble(txtHam.Text) * Price_Ham;
            itemcost[1] = Convert.ToDouble(txtCheeseb.Text) * Price_CheeseBurger;
            itemcost[2] = Convert.ToDouble(txtBBQburger.Text) * Price_BBQBurger;
            itemcost[3] = Convert.ToDouble(txtJack.Text) * Price_Jack;
            itemcost[4] = Convert.ToDouble(txtBlack.Text) * Price_Black;
            itemcost[5] = Convert.ToDouble(txtPhilly.Text) * Price_Philly;
            itemcost[6] = Convert.ToDouble(txtChicken.Text) * Price_Chicken;
            itemcost[7] = Convert.ToDouble(txtVeggie.Text) * Price_Veggie;
